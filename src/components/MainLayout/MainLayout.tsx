...
const MainLayout = ({children}: {children: ReactNode}) => {
  ...
  const routeMatch = useRouteMatch(['/home', '/staff', '/customers', '/customers/*', '/laundries', '/orders'])
